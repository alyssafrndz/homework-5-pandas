...
(df.groupby(["gender"]).typeofwealth.value_counts(normalize=True) * 100).round(2)
...
df.sort_values(by="countrycode").sort_values(by="networthusbillion", ascending=False).head(10)
